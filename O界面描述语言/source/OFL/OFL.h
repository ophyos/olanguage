...
OFL_API void* _stdcall OFShowMainWnd(char* pchWndName); //显示主窗口,这是窗口显示后会调用消息循环
OFL_API void* _stdcall OFShowWnd(char* pchWndName); //显示一般窗口
OFL_API void* _stdcall OFGetControl(char* pchControlName); //获取控件
