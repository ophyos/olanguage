...
void CXTreeCtrl::OnBeginLabelEdit(NMHDR* pNMHDR, LRESULT* pResult)
{
	//	TV_DISPINFO* pTVDispInfo = (TV_DISPINFO*)pNMHDR;

	CEdit *pEdit = GetEditControl();
	pEdit->SetLimitText(m_textMaxLen);
...
void CXTreeCtrl::OnEndLabelEdit(NMHDR* pNMHDR, LRESULT* pResult)
{
	TV_DISPINFO *pTVDispInfo = (TV_DISPINFO *)pNMHDR;
...
void CXTreeCtrl::OnLButtonUp(UINT nFlags, CPoint point) 
{
	...
	if( m_bDragging )
	{
		...
		if(m_bCancelDrag || (m_hItemDragS == m_hItemDragD))
		{
