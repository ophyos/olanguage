...
//Misc
  ...
  char* WcsToMbs( const wchar_t* pwcs);
  wchar_t* MbsToWcs( const char* pmbs );
...
//Unicode support
  ...
  void AutoCShow(int lenEntered, const wchar_t* itemList, BOOL bShow = TRUE, BOOL bDirect = TRUE);
  ...
  static int WCS2MBS( const wchar_t* pwcs, int nLength,char*& psz);
  static int MBS2WCS( const char* pmbs, int nLength,wchar_t*& pwcs);
  static int ANSI2UTF8(const char* pszText,int nLength,char*& pszUTF8);
  static int UTF82ANSI(const char* pszUTF8Text,int nLength,char*& pchANSI);
...
//Auto generated using the "ConvertScintillaiface.js" script
  void AddUTF8Text(int length, const char* text, BOOL bDirect = TRUE);
  ...
  void AutoCShow(int lenEntered, const char* itemList,BOOL bShow = TRUE,BOOL bDirect = TRUE);
  ...
  void AutoCSelect(int nItem, BOOL bDirect = TRUE);
