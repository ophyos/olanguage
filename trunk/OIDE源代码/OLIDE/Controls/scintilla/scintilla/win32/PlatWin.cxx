...
void Plat_Font::Create(const char *faceName, int characterSet, int size,
...
public:
	...
	void DrawTextCommon(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, UINT fuOptions);
	void DrawTextNoClip(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back);
	void DrawTextClipped(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back);
	void DrawTextTransparent(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore);
	void MeasureWidths(Plat_Font &font_, const char *s, int len, int *positions);
	int WidthText(Plat_Font &font_, const char *s, int len);
	int WidthChar(Plat_Font &font_, char ch);
	int Ascent(Plat_Font &font_);
	int Descent(Plat_Font &font_);
	int InternalLeading(Plat_Font &font_);
	int ExternalLeading(Plat_Font &font_);
	int Height(Plat_Font &font_);
	int AverageCharWidth(Plat_Font &font_);
...
void SurfaceImpl::Release() {
	...
	brush = 0;
	if (fontOld) {
		// Fonts are not deleted as they are owned by a Plat_Font object
...
void SurfaceImpl::SetFont(Plat_Font &font_) {
	if (font_.GetID() != font) {
		if (fontOld) {
...
void SurfaceImpl::DrawTextCommon(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, UINT fuOptions) {
	SetFont(font_);
	RECT rcw = RectFromPRectangle(rc);
	SIZE sz={0,0};
	int pos = 0;
...
void SurfaceImpl::DrawTextNoClip(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len,
...
void SurfaceImpl::DrawTextClipped(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len,
	ColourAllocated fore, ColourAllocated back) {
	::SetTextColor(hdc, fore.AsLong());
	::SetBkColor(hdc, back.AsLong());
...
void SurfaceImpl::DrawTextTransparent(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len,
...
int SurfaceImpl::WidthText(Plat_Font &font_, const char *s, int len) {
	SetFont(font_);
	SIZE sz={0,0};
	if (unicodeMode) {
		wchar_t tbuf[MAX_US_LEN];
...
void SurfaceImpl::MeasureWidths(Plat_Font &font_, const char *s, int len, int *positions) {
	SetFont(font_);
	SIZE sz={0,0};
	int fit = 0;
	if (unicodeMode) {
...
int SurfaceImpl::WidthChar(Plat_Font &font_, char ch) {
	SetFont(font_);
	SIZE sz;
...
int SurfaceImpl::Ascent(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
...
int SurfaceImpl::Descent(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
	return tm.tmDescent;
...
int SurfaceImpl::InternalLeading(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
int SurfaceImpl::ExternalLeading(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
int SurfaceImpl::Height(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
	return tm.tmHeight;
...
int SurfaceImpl::AverageCharWidth(Plat_Font &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
void Window::SetFont(Plat_Font &font) {
...
public:
	...
	virtual void SetFont(Plat_Font &font);
...
void ListBoxX::SetFont(Plat_Font &font) {
	LOGFONT lf;
