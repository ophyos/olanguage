...
public:
	...
	UINT GetData(BYTE *pByte, UINT nLength,UINT nOffset = 0);
	...
	void SetAddrOffset(UINT nAddrOffset){ m_nAddrOffset = nAddrOffset;}
	UINT GetAddrOffset(){ return m_nAddrOffset;}
	...
	UINT GetDataLength() const { return m_nLength; }
