...
protected:
	...
	int ascent;
#endif
	// Private so Plat_Font objects can not be copied
	Plat_Font(const Plat_Font &) {}
	Plat_Font &operator=(const Plat_Font &) { id=0; return *this; }
public:
	Plat_Font();
	virtual ~Plat_Font();
...
public:
	...
	virtual void DrawTextNoClip(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextClipped(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextTransparent(PRectangle rc, Plat_Font &font_, int ybase, const char *s, int len, ColourAllocated fore)=0;
	virtual void MeasureWidths(Plat_Font &font_, const char *s, int len, int *positions)=0;
	virtual int WidthText(Plat_Font &font_, const char *s, int len)=0;
	virtual int WidthChar(Plat_Font &font_, char ch)=0;
	virtual int Ascent(Plat_Font &font_)=0;
	virtual int Descent(Plat_Font &font_)=0;
	virtual int InternalLeading(Plat_Font &font_)=0;
	virtual int ExternalLeading(Plat_Font &font_)=0;
	virtual int Height(Plat_Font &font_)=0;
	virtual int AverageCharWidth(Plat_Font &font_)=0;
...
public:
	...
	virtual void SetFont(Plat_Font &font)=0;
